# -*- coding: utf-8 -*-
"""Silvia Ocaña  SpaceX - 1 - Data Collection Api.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fDDCDCj-Gq7s8K94u1x_7VJWbZd1m9Pc
...
def getPayloadData(data): #Definimos la función
    for x in data['payloads']: #Iteramos por cada fila de la columna PayloadData
       if x: #Comprobamos que no este vacía
        ...
        Customers.append(response['customers']) #Añadimos a Customers tude el valor con key 'customers'
        PayloadMass.append(response['mass_kg']) #Añadimos a PayloadMass Site el valor con key 'mass_kg'
        Orbit.append(response['orbit']) #Añadimos a Orbit Site el valor con key 'orbit'
...
# INSERTA AQUÍ TU CÓDIGO
condicion = launch_data['BoosterVersion'] != "Falcon 1"
...
# INSERTA AQUI TU CÓDIGO
data_falcon9['LandingPad'] = data_falcon9['LandingPad'].fillna('Not ')
media = data_falcon9['PayloadMass'].mean()
data_falcon9['PayloadMass'] = data_falcon9['PayloadMass'].replace(np.nan, media) #np seguido de punto sustituye todo, sea numérico o no
...
#INSERTA AQUÍ TU CÓDIGO
data_falcon9.to_csv(r'dataset_part_1.csv', index=False, header=True)
